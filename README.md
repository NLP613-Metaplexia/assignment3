...
|--------|---------------------|----------|------|
| 1      | Ritesh Patidar      | 22210034 | Pre-processing of the Dataset |
| 2      | Siddhesh Dosi       | 22210045 | Pretraining pipeline of the BERT model |
...
| 5      | Ankit Yadav         | 22270001 | Computation of the perplexity metric |
| 6      | Sai Krishna Avula   | 22210036 | Documentation of the pre-training |
